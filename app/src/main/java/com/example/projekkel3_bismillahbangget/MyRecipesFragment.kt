...
class MyRecipesFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val btnmovetotips: Button = v.findViewById(R.id.tips)

        btnmovetoresep.setOnClickListener(this)
        btnmovetotips.setOnClickListener(this)
        return v
    }
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.tips -> {
                val movetips = Intent(getActivity(), EditProfileActivity::class.java)
                startActivity(movetips)
            }
        }
    }
}